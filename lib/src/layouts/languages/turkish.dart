...
/// Turkish Q-keyboard text layout - primary (letters).
/// QWERTY variant with Turkish-specific characters: ç, ş, ğ, ı, ö, ü.
/// Turkish alphabet has no q, w, x but the Q-keyboard (most common) keeps QWERTY base.
/// Mobile layout: ğ and ü after p, ş after l, ı and ö and ç on row 3.
final KeyboardLayout _textLayoutPrimary = [
  [
    ...
    VirtualKey.character(text: 'ı', capsText: 'I'),
    VirtualKey.character(text: 'o'),
    VirtualKey.character(text: 'p'),
    VirtualKey.character(text: 'ğ'),
  ...
  [
    ...
    VirtualKey.character(text: 'ş'),
    VirtualKey.character(text: 'i', capsText: 'İ'),
  ],
  [
    ...
    VirtualKey.character(text: 'ç'),
    VirtualKey.action(action: KeyAction.backSpace, flex: 1.5),
  ],
  [
    VirtualKey.action(action: KeyAction.symbols, flex: 2.5),
    VirtualKey.character(text: ','),
    VirtualKey.action(action: KeyAction.space, flex: 5),
    VirtualKey.character(text: '.'),
    VirtualKey.action(action: KeyAction.enter, flex: 2.5),
  ],
];
...
final KeyboardLayout _emailLayoutPrimary = [
  ...
  [
    ...
    VirtualKey.character(text: '_'),
    VirtualKey.character(text: '-'),
    VirtualKey.action(action: KeyAction.done, flex: 2),
  ],
];
...
final KeyboardLayout _urlLayoutPrimary = [
  ...
  [
    ...
    VirtualKey.character(text: '-'),
    VirtualKey.character(text: ':'),
    VirtualKey.action(action: KeyAction.go, flex: 2),
  ],
];
...
final KeyboardLanguage turkishLanguage = KeyboardLanguage(
  code: 'tr',
  name: 'Turkish',
  nativeName: 'Türkçe',
