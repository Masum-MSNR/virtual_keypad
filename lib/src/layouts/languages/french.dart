...
final KeyboardLayout _textLayoutSecondary = [
  ...
  [
    VirtualKey.action(action: KeyAction.symbolsAlt),
    VirtualKey.character(text: '*'),
    VirtualKey.character(text: '"'),
    VirtualKey.character(text: "'"),
    VirtualKey.character(text: ':'),
...
final KeyboardLayout _textLayoutTertiary = [
  [
    ...
    VirtualKey.character(text: '`'),
    VirtualKey.character(text: '|'),
    VirtualKey.character(text: 'ΓÇó'),
    VirtualKey.character(text: 'ΓêÜ'),
    VirtualKey.character(text: '╧Ç'),
    VirtualKey.character(text: '├╖'),
    VirtualKey.character(text: '├ù'),
    VirtualKey.character(text: '┬º'),
    VirtualKey.character(text: 'Γêå'),
  ],
  [
  ...
  [
    ...
    VirtualKey.character(text: '┬⌐'),
    VirtualKey.character(text: '┬«'),
    VirtualKey.character(text: 'Γäó'),
    VirtualKey.character(text: 'Γ£ô'),
    VirtualKey.character(text: '['),
    VirtualKey.character(text: ']'),
    VirtualKey.action(action: KeyAction.backSpace),
  ],
