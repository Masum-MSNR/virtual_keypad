...
/// Portuguese QWERTY text layout - primary (letters).
/// Standard QWERTY with ç added after 'l' on row 2.
...
/// Text layout - tertiary (accented characters & more symbols).
final KeyboardLayout _textLayoutTertiary = [
  [
    VirtualKey.character(text: 'á'),
    VirtualKey.character(text: 'â'),
    VirtualKey.character(text: 'ã'),
    VirtualKey.character(text: 'à'),
    VirtualKey.character(text: 'é'),
    VirtualKey.character(text: 'ê'),
    VirtualKey.character(text: 'í'),
    VirtualKey.character(text: 'ó'),
    VirtualKey.character(text: 'ô'),
    VirtualKey.character(text: 'õ'),
  ],
  [
    VirtualKey.character(text: 'ú'),
...
final KeyboardLanguage portugueseLanguage = KeyboardLanguage(
  code: 'pt',
  name: 'Portuguese',
